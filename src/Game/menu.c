 ...
 * underlying slot. With sf3_btn_label's L/R + ZL/ZR glyph swap, the rows read
 * top-to-bottom Y, X, L, R, B, A, ZR, ZL. Used here (editing) and in EFF10.c
 * (glyph + function name). Rows 8/9/10 = vibration/default/exit bypass this. */
const u8 Button_Cfg_Order[8] = { 5, 4, 2, 6, 1, 0, 3, 7 };
