...
int cseSendBd2SpuWithId(void* data, u32 size, u32 bank, u32 id) {
    bank &= 0xF;
    u32 bankAddr = mlMemMapGetBankAddr(bank);
...
void q_ldreq_color_data(REQ* curr) {
    ...
    case 0:
        ...
        // Type 10 (character BD sound): load through queue, don't skip
